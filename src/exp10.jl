...
@inline _exp10{T}(x::T) = @horner_oftype(x, 0.86858896380650363333586483349790796637535095214844,
...
@inline _exp10{T<:SmallFloat}(x::T) = @horner_oftype(x, 0.868588924407958984375,
